...
export default function MarketPage() {
  ...
  const filtersInitialValue = [
    {id: 1, name: 'Sendbox', category: 'platform', selected: false},
    {id: 2, name: 'Platform A', category: 'platform', selected: false},
    {id: 3, name: 'Platform B', category: 'platform', selected: false},
    {id: 4, name: 'Platform C', category: 'platform', selected: false},
    {id: 5, name: 'Azuki', category: 'collection', selected: false},
    {id: 6, name: 'BAYC', category: 'collection', selected: false},
    {id: 7, name: 'Doodles', category: 'collection', selected: false},
    {id: 8, name: 'Space Doodles', category: 'collection', selected: false},
    {id: 9, name: 'Lorem Ipsum', category: 'collection', selected: false},
  ];
      ...
      <div
        ...
        <div className="lg:relative lg:block lg:flex-none">
          ...
          <button
            ...
            type="button">
            <span>Platforms</span>
            <svg className="w-4 h-4 ml-2 float-right"
                 aria-hidden="true"
                 fill="none"
                 stroke="currentColor"
                 viewBox="0 0 24 24"
          ...
          <div id="dropdown"
            ...
            <div className="flex w-full flex-wrap">
              {/* Platform chips */}
              {filters.filter(filter => filter.category === 'platform').map((platform) => (
          ...
          <div id="dropdown"
            ...
            <div className="flex w-full flex-wrap">
              {/* Collection chips */}
              {filters.filter(filter => filter.category === 'collection').
                map((collection) => (
        ...
        <div
          className="min-w-0 max-w-2xl flex-auto pl-4 lg:max-w-none lg:pl-6 text-white">
          <div className="flex flex-row">
